...
const AllFeatures = () => {
  ...
  return (
    <div className="all-features overflow-hidden">
      <div>
        <h2 className="all-features-title">All in one bank. Really.</h2>
        <p className="all-features-details">
          Senectus et netus malesuada fames ac turips. Sagittis vitae er leo
          duis ut diam 
        </p>
      </div>
      <div className="statistics-first-part">
        <div className="statistics">
          <div>
            <h2 className="statistics-title">statistics</h2>
            <p className="statistics-details">
          ...
          <div className="statistics-mobile">
            ...
            <div className="statistics-cards">
              <div className="statistics-card">
                <div>
                  <p className="statistics-card-tex">Earnings</p>
                </div>
                <div>
                  <p className="statistics-card-price">$85.222,00</p>
                </div>
              </div>
              <div className="statistics-card">
                <div>
                  <p className="statistics-card-text">Expenses</p>
                </div>
                <div>
                  <p className="statistics-card-price">-$52.150,00</p>
                </div>
              </div>
            </div>
        ...
        <div className="statistics overflow-hidden">
        <div>
      <div className="hero">
      <div className="hero-text">
        <div>
          <p className="text-4xl font-bold">Card</p>
      ...
      <div className="flex gap-11 justify-between justify-items-end ">
        ...
        <div className="relative h-96 w-96">
          <div className="absolute -top-10 -left-56 h-96 rotate-90"><BlackCard/></div>
          
        </div>

        <div className="relative h-96 w-96">
          <div className="absolute -top-16 -left-48 h-96 rotate-90"><BlueCard/></div>
          
        </div>
       
        <div className="relative h-96 w-96">
          <div className="absolute -top-10 -left-32 h-96 rotate-90"><GoldCard/></div>
      ...
      <div className="all-features-last-3card">
